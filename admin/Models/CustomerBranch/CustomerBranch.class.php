...
<?php
	Class CustomerBranch
	{
		...
		public function __construct()
		{
			...
			$this->messages=parse_ini_file('CustomerBranch_msg.ini');
			$this->table = "wdbt.tblCustomerBranches";
			$this->child = "";
			$this->view = "wdbt.vwCustomerBranches";
			$this->primaryKey = "custBranchId";
		} //constructor()
		...
		{
			if($property == "custBranchId" || $property == "custId" || $property == "branchId" )
			{
		...
		public function getCustomerBranch($field_list="*" ,$where="", $order="" ,$limit="",$table=true)
		{
			if($table)
		...
		{
			$query = sprintf("DELETE FROM %s WHERE custBranchId = %d",$this->table,$this->data["custBranchId"]); 
			//return $query;
			try 
			{ 
				$config  = array( PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, PDO::ATTR_EMULATE_PREPARES => false);
		...
		{
			$query = sprintf("INSERT INTO %s (custId,branchId) VALUES(%d,%d )",$this->table,$this->data['custId'],$this->data['branchId']); 
			//return $query;
			try 
			{ 
				$config  = array( PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, PDO::ATTR_EMULATE_PREPARES => false);
		...
		public function saveCustomerBranch()
		{
			$query = sprintf("UPDATE %s set  custId = %d, branchId = %dwhere custBranchId = %d ",$this->table,$this->data['custId'],$this->data['branchId'],$this->data['custBranchId']); 
			//return $query;
			try 
			{ 
				$config  = array( PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, PDO::ATTR_EMULATE_PREPARES => false);
